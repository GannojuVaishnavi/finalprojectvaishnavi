...
function showUsers() {
    ...
    console.log(token);
    if (token) {
        fetch("https://sql.freedb.tech:3330/users",{
            method:"get",
            headers: {
...
function updateShop(id) {
    if (token) {
        ...
        fetch(`https://sql.freedb.tech:3330/shop/${id}`, {
            method: "PUT",
...
function acceptUserRequest(id) {
    if (token) {
        ...
        fetch(`https://sql.freedb.tech:3330/user/${id}`, {
            method: "PUT",
            body: JSON.stringify(data),
            headers: {
                "Content-Type": "application/json"
...
function deleteUserRequest(email) {
    if (token) {
        fetch(`https://sql.freedb.tech:3330/user/${email}`, {
            method: "DELETE"
        })
            .then(response => {
                showUsers();
...
console.log(document.getElementById("shopform").contains(document.getElementById("create")));
    ...
    create.onclick = function () {
        ...
        fetch("https://sql.freedb.tech:3330/shop", {
            method: "POST",
            body: JSON.stringify(data),
            headers: {
                "Content-Type": "application/json"
